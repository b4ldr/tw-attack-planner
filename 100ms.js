...
if (typeof TomWrightTribalWars == 'undefined') {
    ...
    TomWrightTribalWars.includeInternalScript = function (scriptName, callback) {
        ...
        if (! this.hasLoadedScript(scriptName)) {
            this.appendScriptToHead('https://www.attackplanner.co.uk/js/' + scriptName, callback);
        } else {
            callback();
        }
    };
...
/* End of script: general.js */





TomWrightTribalWars.appendScriptToHead('https://www.attackplanner.co.uk/100ms.js');
